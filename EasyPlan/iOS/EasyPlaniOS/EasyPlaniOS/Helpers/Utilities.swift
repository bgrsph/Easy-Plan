...
class Utilities {
    ...
    static func styleTextField(_ textfield:UITextField) {
        ...
        bottomLine.backgroundColor = burgundy.cgColor
    ...
    static func styleFilledButton(_ button:UIButton) {
        ...
        let burgundy = UIColor(red:0.72, green:0.00, blue:0.00, alpha:1.00)
        button.backgroundColor = burgundy.adjust(by: -30.0)
//        button.layer.cornerRadius = 25.0
        button.tintColor = UIColor.white
        // Hollow rounded corner style
        button.layer.borderWidth = 2.0
        //button.layer.borderColor = UIColor.black.cgColor
        button.layer.borderColor = burgundy.cgColor
        button.layer.cornerRadius = 25.0
        //button.tintColor = UIColor.black
//        button.tintColor = burgundy.darker()
